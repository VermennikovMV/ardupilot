...
class ModeFigureEight : public Mode
{
public:

    Number mode_number() const override { return Number::FIGURE_EIGHT; }
    const char *name() const override { return "FIGURE8"; }
    const char *name4() const override { return "FG8T"; }
