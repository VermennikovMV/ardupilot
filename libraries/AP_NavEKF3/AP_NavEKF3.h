...
#define FLOW_USE_TERRAIN 2
    ...
    const uint16_t deadReckonDeclare_ms = 0;    // Time without equivalent position or velocity observation to constrain drift before dead reckoning is declared (msec)
